  ...
  return (
    <footer className="bg-[var(--gradient-dark)] border-t border-border mt-20">
      <div className="container-x py-16 grid gap-12 md:grid-cols-4">
        ...
        <div>
          <h4 className="text-sm font-semibold text-gold mb-4 uppercase tracking-wider">Navegação</h4>
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li><Link to="/" className="hover:text-gold">Home</Link></li>
            <li><Link to="/sobre" className="hover:text-gold">Sobre</Link></li>
            <li><Link to="/choppes" className="hover:text-gold">Nossos Chopps</Link></li>
            <li><Link to="/eventos" className="hover:text-gold">Eventos</Link></li>
            <li><Link to="/revendedores" className="hover:text-gold">Revendedores</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li className="flex gap-2"><Phone className="w-4 h-4 text-gold shrink-0" /> {SITE.phone}</li>
            <li className="flex gap-2"><Mail className="w-4 h-4 text-gold shrink-0" /> {SITE.email}</li>
            <li className="flex gap-2"><MapPin className="w-4 h-4 text-gold shrink-0" /> {SITE.address}</li>
            <li className="flex gap-2"><Clock className="w-4 h-4 text-gold shrink-0" /> {SITE.hours}</li>
          </ul>
        </div>

        <div>
          <h4 className="text-sm font-semibold text-gold mb-4 uppercase tracking-wider">Atendemos</h4>
          ...
          <a href={SITE.instagram} target="_blank" rel="noopener"
            ...
            <Instagram className="w-4 h-4" /> @goldenchopp
          </a>
        </div>
      </div>
