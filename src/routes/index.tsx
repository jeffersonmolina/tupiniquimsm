      ...
      <section className="relative min-h-[92vh] flex items-center overflow-hidden">
        ...
        <div className="container-x relative z-10 py-24">
          <div className="max-w-3xl animate-fade-up">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-display leading-[1.05] mb-6">
              O verdadeiro sabor do <span className="text-gold-grad">chopp artesanal</span> direto para sua festa, evento ou negócio.
            </h1>
