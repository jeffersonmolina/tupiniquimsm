...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Cervejaria Tupiniquim — Chopp Artesanal Premium em Santa Maria/RS" },
      {
        name: "description",
        content:
          "Chopp artesanal gelado entregue em até 60 minutos em Santa Maria/RS. Chopeiras profissionais, estilos e atendimento premium. Peça agora no WhatsApp.",
      },
      { property: "og:title", content: "Cervejaria Tupiniquim — Chopp Artesanal Premium" },
      {
        property: "og:description",
        content:
          "Chopp artesanal gelado, entrega rápida e chopeiras profissionais em Santa Maria/RS.",
      },
        ...
        <div className="container-x relative z-10 py-24">
          <div className="max-w-3xl animate-fade-up">
            ...
            <p className="text-lg md:text-xl text-foreground/80 max-w-2xl mb-8 leading-relaxed">
              Entrega rápida, chopeiras profissionais e qualidade em cada litro.
            </p>
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                to="/revendedores"
                className="btn-ghost-gold hover:bg-gold hover:text-primary-foreground"
              >
      ...
      <section className="container-x -mt-12 relative z-20">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {[
            ...
            { icon: Wrench, t: "Chopeiras profissionais", d: "Equipamentos inclusos" },
            { icon: Award, t: "+27 anos", d: "Cervejaria Premiada" },
          ].map((b, i) => (
            <div
              key={i}
              className="card-premium p-5 flex items-center gap-3 hover:-translate-y-1 transition-transform"
            >
        ...
        <div className="container-x grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-display leading-tight mt-3 mb-5">
              Tradição cervejeira com <span className="text-gold-grad">alma gaúcha</span>.
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              A {SITE.name} nasceu da paixão por chopp de verdade — feito com maltes selecionados,
              lúpulos nobres e água pura. Cada barril sai da fábrica com o mesmo cuidado de um lote
              especial.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-8">
              Mais de duas décadas aprimorando processos, controle de qualidade rigoroso e uma
      ...
      <section className="section-pad">
        <div className="container-x grid lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <h2 className="text-3xl md:text-5xl font-display leading-tight mt-3 mb-5">
              O <span className="text-gold-grad">chopp perfeito</span> para a sua festa.
            </h2>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Casamentos, formaturas, corporativos ou aquela festa entre amigos — entregamos barris,
              chopeiras e suporte completo para o seu evento ser inesquecível.
            </p>
          ...
          <div className="order-1 lg:order-2 grid grid-cols-2 gap-4">
            <img
              src={eventImg}
              alt="Evento com chopp artesanal"
              loading="lazy"
              width={1600}
              height={1100}
            ...
            {[
              {
                n: "01",
                t: "Escolha seu chopp",
                d: "Veja nosso catálogo e escolha o estilo ideal.",
              },
            ...
            {[
              {
                n: "Mariana S.",
                e: "Casamento",
                t: "Chopp impecável, gelado e cremoso do início ao fim. Atendimento nota 10!",
              },
              {
                n: "Lucas P.",
                e: "Festa de 30 anos",
                t: "Entrega no horário, chopeira excelente e sabores incríveis. Recomendo demais.",
              },
              {
                n: "Roberto M.",
                e: "Confraternização",
                t: "Profissionalismo do começo ao fim. Nossos convidados elogiaram muito.",
              },
              {
                n: "Junior Costa",
                e: "Aniversário",
                t: "O melhor chopp de Santa Maria, incomparável, atendimento excelente!",
              },
            ].map((d, i) => (
        ...
        <div className="container-x">
          ...
          >
            ...
            <div className="relative z-10 max-w-2xl mx-auto text-primary-foreground">
              <CircleDollarSign className="w-10 h-10 mx-auto mb-4" />
              <h2 className="text-3xl md:text-5xl font-display mb-4">
                Seja um Parceiro Tupiniquim
              </h2>
              <p className="mb-8 text-primary-foreground/85">
                Produto premium, alta saída, suporte comercial completo. Comece sua renda extra com
                a gente.
              </p>
              <Link
                to="/revendedores"
                className="inline-flex items-center gap-2 bg-background text-foreground font-semibold px-7 py-3 rounded-full hover:scale-105 transition-transform"
              >
